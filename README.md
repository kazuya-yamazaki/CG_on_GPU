...
* 本レポジトリではサンプルプログラムを掲載していますが、現時点では詳しい解説は付けていません。東京大学情報基盤センターでは[お試しアカウント付き並列プログラミング講習会](https://www.cc.u-tokyo.ac.jp/events/lectures/)を多数開催しており、過去のGPU化に関する講習会の資料も公開されていますので、そちらもご参照ください。
...
* ソルバーにおける袖領域通信: `solver_SR.c`および`solver_SR.f`
